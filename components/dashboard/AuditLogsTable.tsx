                        ...
                        <div>
                            ...
                            >
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="DSR_CREATE">
                                        DSR Create
                                    </SelectItem>
                                    <SelectItem value="DSR_UPDATE">
                                        DSR Update
                                    </SelectItem>
                                    <SelectItem value="DSR_STATUS_CHANGE">
                                        DSR Status Change
                                    </SelectItem>
                                    ...
                                    <SelectItem value="COMPANY_CREATE">
                                        Company Create
                                    </SelectItem>
                                </SelectContent>
                            </Select>
                            ...
                            <div className="text-center mt-6">
                                ...
                                >
                                    {loading ? (
                                        <>
                                            <svg
                                                className="animate-spin -ml-1 mr-2 h-4 w-4 text-muted-foreground inline"
                                                fill="none"
                                                viewBox="0 0 24 24"
                                            >
                                                <circle
